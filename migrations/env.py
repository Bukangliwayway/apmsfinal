...
def include_object(object, name, type_, reflected, compare_to):
    ...
    ignored_tables = {
        ...
        'SPSLatestBatchSemester',
        'ESISRole',
        'RISset_defense_class',
        'SGEInsertDataQueues',
        'SGEStudentOrganization',
        'SGECertifications',
        'SGEEligibles',
        'SGESavedPosition',
        'SGEElectionAppeals',
        'SGEOrganizationOfficer',
        'SGEElection',
        'SGECode',
        'SGERules',
        'RISset_defense',
        'SGERatingsTracker',
        'SGECreatedElectionPosition',
        'SGECandidates',
        'SGEOrganizationMember',
        'SGECreatedAdminSignatory',
        'SGEElectionAnalytics',
        'APMSAnnouncement',
        'SGECoC',
        'SGEElectionWinners',
        'SGEComelec',
